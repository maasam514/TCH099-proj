...
public class StatsEquipeAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View view, @NonNull ViewGroup parent) {
        ...
        if (presenteur.getStatsEquipe(position) != null) {
            ...
            tvV.setText(Integer.toString(presenteur.getStatsEquipe(position).getNbVictoire()));
            tvD.setText(Integer.toString(presenteur.getStatsEquipe(position).getNbDefaite()));
            tvN.setText(Integer.toString(presenteur.getStatsEquipe(position).getNbNul()));
            tvP.setText(Integer.toString(presenteur.getStatsEquipe(position).getNbPoint()));
        }
        return view;
    }
}
