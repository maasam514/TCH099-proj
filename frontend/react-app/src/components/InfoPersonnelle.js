    ...
    useEffect(() => {
        const fetchDonnees = async () => {
            try {
                ...
                let reponse = await fetch(`https://tch-099-proj.vercel.app/api/api/joueur/${id}`);
                ...
                reponse = await fetch(`https://tch-099-proj.vercel.app/api/api/statistique/joueur/${id}`);
                data = await reponse.json();
                setStatJoueur(data);
            } catch (erreur) {
